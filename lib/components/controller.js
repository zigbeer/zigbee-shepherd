...
Controller.prototype.bind = function (srcEp, dstEp, cId, grpId, callback) {
    return this.querie.setBindingEntry('bind', srcEp, dstEp, cId, grpId, callback);
};

Controller.prototype.unbind = function (srcEp, dstEp, cId, grpId, callback) {
    return this.querie.setBindingEntry('unbind', srcEp, dstEp, cId, grpId, callback);
};
