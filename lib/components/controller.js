...
Controller.prototype.zclFoundation = function (dstEp, cId, attrIdArray, callback) {
    ...
    zclPacket = zcl.frame(frameCntl, manufId, seqNum, 'read', zclPayload);
...
Controller.prototype.zclRead = function (dstEp, cId, attrIdArray, callback) {
    ...
    zclRspEvt = 'ZCL:FOUNDATION:read:' + seqNum;
    this.once(zclRspEvt, function (zclRspPayload) {
        deferred.resolve(zclRspPayload);
    });
...
Controller.prototype.zclCommand = function (dstEp, cId, valObj, callback)  {
    // [TODO] functional
};
