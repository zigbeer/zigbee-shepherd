...
function Zdo(znp) {
    this._zdoCallbacks = {};
    // if (typeof Zdo.instance === "object") {
    //     return Zdo.instance;
    // }
    // Zdo.instance = this;
    
    // this.areqListResolvers = {};    // a place to hold the resolvers
    
    // this.onSeverDiscRsp = function (msg) {};
    // this.onStateChangeInd = function (msg) {};
    // this.onEndDeviceAnnceInd = function (msg) {};
    // this.onMatchDescRspSent = function (msg) {};
    // this.onStatusErrorRsp = function (msg) {};
    // this.onSrcRtgInd = function (msg) {};
    // this.onBeaconNotifyInd = function (msg) {};
    // this.onLeaveInd = function (msg) {};
    // this.onMsgCbIncoming = function (msg) {};
    
    // msghub.addListener('ZDO:SERVER_DISC_RSP', this.onSeverDiscRsp);
    // msghub.addListener('ZDO:STATE_CHANGE_IND', this.onStateChangeInd);
    // msghub.addListener('ZDO:END_DEVICE_ANNCE_IND', this.onEndDeviceAnnceInd);
    // msghub.addListener('ZDO:MATCH_DESC_RSP_SENT', this.onMatchDescRspSent);
    // msghub.addListener('ZDO:STATUS_ERROR_RSP', this.onStatusErrorRsp);
    // msghub.addListener('ZDO:SRC_RTG_IND', this.onSrcRtgInd);
    // msghub.addListener('ZDO:BEACON_NOTIFY_IND', this.onBeaconNotifyInd);
    // msghub.addListener('ZDO:LEAVE_IND', this.onLeaveInd);
    // msghub.addListener('ZDO:MSG_CB_INCOMING', this.onMsgCbIncoming);
}
