...
zdoReqRspMap = {
    ...
    serverDiscReq:      { ind: 'serverDiscRsp',     apiType: 'special', suffix: []                                  }, // [ 'srcaddr' ],  may not response
    ...
    mgmtNwkUpdateReq:   null,  // undefined, null, or { ind = null }, 'rspless'
    // endDeviceAnnce:     null,
    // msgCbRegister:      null,
    // msgCbRemove:        null,
    // startupFromApp:     null,
...
zdoIndSuffix = {
    ...
    serverDiscRsp:     null,            // special, listen at controller.on('ZDO:serverDiscRsp') [ 'srcaddr' ],
    ...
    stateChangeInd:    null,    // very special, tackled in controller._zdoIndicationEventBridge()
    // endDeviceAnnceInd: null, // undefined, null, or []. no sub-event suffix 
...
zdoHelper.getRequestType = function (reqName) {
    var meta = zdoReqRspMap[reqName];
    return meta ? meta.apiType : undefined;
};
