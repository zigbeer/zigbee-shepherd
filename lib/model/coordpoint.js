...
afCnfEventName = 'AF:DATA_CONFIRM:' + this.getEpId();
this.isDelegator = false;
if (this.getEpId() < 11) {
    this.isDelegator = true;    // enpointId 1 - 10 are reserved for profile delegating
}
