...
Cluster.prototype.addAttributes = function (attrs) {
    var self = this;

    attrs.forEach(function (attr, attrId) {
        self.addSingleAttribute(attrId, attr.value);
    });
};

Cluster.prototype.addSingleAttribute = function (attrId, value) {
    var attrIdItem = zclId.getAttrId(this.cId, attrId),
        attrAcl = zclId.getAttrAcl(this.cId, attrId);

    this.attrs[attrIdItem.key] = { acl: attrAcl, value: value };
};
