...
function Endpoint(device, epInfo) { 
    ...
    this.inClusterList = epInfo.inClusterList;      // numbered cluster ids
    this.outClusterList = epInfo.outClusterList;    // numbered cluster ids
...
Endpoint.prototype.getInCList = function () {
    return this.inCList;
};

Endpoint.prototype.getOutCList = function () {
    return this.outCList;
};
...
Endpoint.prototype.findCluster = function (cId) {
    return this.clusters.find(function (cluster) {
        return cluster.getClusterId() === cId;
    });
};

Endpoint.prototype.findOutCluster = function (cId) {
    return this.clusters.find(function (cluster) {
        if (1 === cluster.dir)
            return cluster.getClusterId() === cId;
    });
...
Endpoint.prototype.findInCluster = function (cId) {
    return this.clusters.find(function (cluster) {
        if (2 === cluster.dir)
            return cluster.getClusterId() === cId;
    });
