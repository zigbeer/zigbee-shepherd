...
function Endpoint(device, simpleDesc) { 
    ...
    // this.clusters = {
    //     genBasic: {
    //         dir: 1,     // 0: 'unknown', 1: 'in', 2: 'out', 3: 'in' and 'out'
    //         attrs: {
...
Endpoint.prototype.dump = function () {
    return {
        ...
        clusters: this.clusters.dumpSync()
    };
};
...
// endpoint.foundation = function (cId, cmd, zclData, cfg, callback) {};    // foundation method will be attached in shepherd
// endpoint.functional = function (cId, cmd, zclData, cfg, callback) {};    // functional method will be attached in shepherd
