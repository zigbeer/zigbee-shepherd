...
ZShepherd.prototype.bind = function (srcEp, dstEp, cId, callback) {
    return this.controller.bind(srcEp, dstEp, cId, callback);
};

ZShepherd.prototype.unbind = function (srcEp, dstEp, cId, callback) {
    return this.controller.unbind(srcEp, dstEp, cId, callback);
};
